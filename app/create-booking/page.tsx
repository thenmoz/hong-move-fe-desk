...
export default function CreateBookingPage() {
  ...
  const handleConfirm = () => {
    // TODO: Save booking to database/API with formData.source = 'admin-booking'
    // When implementing API call, include source in the payload:
    // const payload = { ...formData, source: formData.source };
    setShowConfirmModal(false);
    // Navigate to booking list (booking number generated by API after creation)
        ...
        >
          <div className="text-center">
            <p className="text-lg font-semibold text-slate-800">
              หมายเลขบุ๊กกิ้งจะถูกสร้างอัตโนมัติหลังบันทึก
            </p>
